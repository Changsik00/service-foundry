# phase-17: Deploy (k8s manifest 예제)

> 보일러플레이트의 마지막 단계 — 배포 예제(컨테이너 오케스트레이션).
> ⚠️ 2026-06-02 재배치: CI/CD(PR 게이트·changesets·docker publish)는 **phase-14 에서 완료**, knip/depcruise 게이트는 phase-15 에서 완료. 본 phase 는 **k8s manifest 예제 잔여분**만. (구 phase-16 → phase-17 로 이동: security-hardening 이 phase-16 우선.)
...
### spec-17-01 — k8s-manifest-example
...
- **Given**: spec-17-01 머지됨, 로컬 클러스터 기동.
