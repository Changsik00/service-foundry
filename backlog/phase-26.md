...
| ID | 슬러그 | 우선순위 | 상태 | 디렉토리 |
|---|---|:---:|---|---|
| `spec-26-01` | id-util-and-audit | P1 | Backlog | `specs/spec-26-01-id-util-and-audit/` |
| `spec-26-02` | users-public-id | P1 | Backlog | `specs/spec-26-02-users-public-id/` |
| `spec-26-03` | auth-boundary-normalize | P1 | Backlog | `specs/spec-26-03-auth-boundary-normalize/` |
